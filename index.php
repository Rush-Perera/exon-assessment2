        ...
        <nav class="navbar bg-body-tertiary">
            <div class="container-fluid">
                ...
                <form class="justify-content-end">
                    <button class="btn btn-outline-primary" type="submit" id="toggleInvoice">Invoices</button>
                    <button class="btn btn-outline-success" type="submit" id="toggleCheque">Cheques</button>
                </form>
            </div>
        </nav>
